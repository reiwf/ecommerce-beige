...
// Query: *[_type == "category"] | order(_createdAt desc)[0...10]
...
// Query: *[    _type == "product"    && name match $searchParam || category match $searchParam     ]
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == \"category\"] | order(_createdAt desc)[0...10]": ALL_CATEGORIES_QUERYResult;
    "*[_type == \"product\"] | order(_createdAt desc)[0...10]": ALL_PRODUCT_QUERYResult;
